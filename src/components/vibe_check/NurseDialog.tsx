...
export const NurseDialog: React.FC<NurseDialogProps> = ({ message, isThinking = false }) => {
    return (
        <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 w-full max-w-2xl px-4 z-50">
            <AnimatePresence>
                <motion.div
                    ...
                    className="bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border border-slate-200 dark:border-slate-700 
                ...
                >
                    ...
                    <div className="p-6 flex items-start gap-4">
                        ...
                        <div className="shrink-0 w-12 h-12 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center border border-slate-200 dark:border-slate-700">

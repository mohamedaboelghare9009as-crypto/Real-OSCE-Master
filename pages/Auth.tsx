...
export default function Auth() {
    ...
    const handleAuth = async (e: React.FormEvent) => {
        ...
        try {
            if (isLogin) {
                ...
                if (error) throw error;
                // Auto sign-in or show check email message
                // For this flow, we assume auto sign-in if email confirmation is disabled or handled
                const from = (location.state as any)?.from?.pathname || '/dashboard';
                navigate(from, { replace: true });
            }
        } catch (err: any) {
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 bg-[#F6F8FA]">
            {/* Left Panel - Visual */}
            <div className="hidden lg:flex flex-col justify-between p-12 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-slate-900/90 to-slate-900/40"></div>
                ...
                <div className="relative z-10 grid grid-cols-2 gap-6">
                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                        ...
                        <div className="text-sm text-slate-400">Clinical Cases</div>
                    </div>
                    <div className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-4 bg-[#F6F8FA] text-slate-500">or continue with</span>
                        </div>
                    </div>

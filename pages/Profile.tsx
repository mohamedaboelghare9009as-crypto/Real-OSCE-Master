                        ...
                        <div className="relative z-10">
                            <div className="flex justify-between items-start mb-4">
                                <div>
                                    ...
                                    <h4 className="text-2xl font-bold text-slate-900">{user.plan} Tier <span className="text-base font-normal text-slate-500">/ $29 mo</span></h4>
                                </div>
                            ...
                            <div className="space-y-2 text-sm text-slate-600 mb-6">
                                ...
                                <div className="flex justify-between">
                                    <span>Usage</span>
                                    <span className="font-bold text-slate-900">{user.stats.sessionsUsed} / {user.stats.sessionsLimit} sessions</span>
                                </div>
                            </div>
  ...
  return (
    ...
    >
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8">
          ...
          <div className="flex-1 text-center md:text-left space-y-4">
             <div>
                ...
                <p className="text-slate-500 font-medium">{user.role} • {user.school}</p>
          ...
          <div className="hidden md:block w-64 bg-slate-50/80 rounded-2xl p-4 border border-slate-100">
             <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-xs font-bold text-emerald-600">{user.stats.sessionsUsed} / {user.stats.sessionsLimit}</span>
             </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
            { label: "Sessions Used", value: user.stats.sessionsUsed, sub: "All time", icon: Activity, color: "text-blue-500", bg: "bg-blue-50" },
            { label: "Average Score", value: `${user.stats.avgScore}%`, sub: "High Pass", icon: Shield, color: "text-emerald-500", bg: "bg-emerald-50" },
            { label: "Current Streak", value: `${user.stats.streak} Days`, sub: "Keep it up!", icon: Zap, color: "text-orange-500", bg: "bg-orange-50" },
        ].map((stat, i) => (
          ...
          <GlassCard className="md:col-span-1 h-full flex flex-col">
             <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500">{user.plan} Tier ($29/mo)</p>
                </div>
             </div>
